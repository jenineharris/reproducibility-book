...
Different software options have different features and capabilities, some of which can make reproducibility more difficult to attain. Excel, for example, relies mostly on a menu-driven interface where the user chooses
